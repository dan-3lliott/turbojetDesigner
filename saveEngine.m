function engine = saveEngine(givens, properties, diffuser, compressor, combustor, turbine, nozzle)
    ...
    %combustor
    casing_radii = [casing_radii combustor.ro3e];
    hub_radii = [hub_radii combustor.ri3e];
    %turbine
    ...
    figure
    hold on
    plot(x_stations, casing_radii, 'Color', ([138, 43, 226]./255));
    plot(x_stations, -casing_radii, 'Color', ([138, 43, 226]./255));
    x_stations(1) = 1;
    x_stations(end) = x_stations(end-1);
    plot(x_stations, hub_radii, 'Color', ([34, 154, 109]./255));
    plot(x_stations, -hub_radii, 'Color', ([34, 154, 109]./255));
    hold off
